...
CREATE INDEX IDX_RESTAURANTS_NOM ON RESTAURANTS(NOM);
CREATE INDEX IDX_VILLES_NPA ON VILLES(CODE_POSTAL);
CREATE INDEX IDX_VILLES_NOM ON VILLES(NOM_VILLE);
CREATE INDEX IDX_TYPES_LIBELLE ON TYPES_GASTRONOMIQUES(LIBELLE);
CREATE INDEX IDX_CRITERES_NOM ON CRITERES_EVALUATION(NOM);